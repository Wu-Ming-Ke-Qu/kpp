...
class AccountModelTests(TestCase):
    ...
    def test_user_total_approve(self):
        ...
        teacher_test = Teacher(teacher_name="lihua", school=school_test, department=department_test)
        teacher_test.save()
        ...
        user_test2 = User(username="user_test2", password=make_password("123456"), email="test2@126.com",
                          school=school_test, department=department_test, is_active=True)
        user_test2.save()
        course_test = Course(course_name="软件工程", course_id="123456", school=school_test,
        ...
        vote_test2.save()
        self.assertEqual(user_test.total_approve(), 2)
    ...
    def test_user_total_approve(self):
        ...
        vote_test2.save()
        self.assertEqual(user_test.total_disapprove(), 2)
